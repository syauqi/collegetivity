...
@section('title', 'Data Artikel — Ciradyka Pramuka SMAN 1 Ciamis')
@section('content')
        ...
        <div class="page-title">
            <div class="card card-absolute">
                <div class="card-header bg-primary">
                    <h5 class="text-white">Data Artikel</h5>
                </div>
                <div class="card-body">
                    <p>Dibawah ini adalah artikel yang telah anda tambahkan. Data dibawah juga bisa anda
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('articles.edit', $item->id)}}" class="btn btn-info px-2">
                                                <svg xmlns="http://www.w3.org/2000/svg"

...
@section('title', 'Data Perlombaan — Ciradyka Pramuka SMAN 1 Ciamis')
@section('content')
        ...
        <div class="page-title">
            <div class="card card-absolute">
                <div class="card-header bg-primary">
                    <h5 class="text-white">Data Perlombaan</h5>
                </div>
                <div class="card-body">
                    <p>Dibawah ini adalah data perlombaan yang tersedia. Data dibawah juga bisa anda
                            ...
                            <table class="display" id="auto-fill">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                                ...
                                                <div class="avatars mr-2">
                                                    <div class="avatar ratio"><img style="object-fit: cover;
                                                        ...
                                                        height: 40px;" class="b-r-8"
                                                            src="https://ui-avatars.com/api/?background=4466f2&color=fff&name={{$item->nama_peserta}}">
                                                    </div>
                                                </div>
                                                <div class="flex-fill">
                                                    <div class="font-weight-bold">{{$item->nama_peserta}}</div>
                                                    <div class="text-muted"><a href="#"
                                                            class="text-reset">{{$item->nama_tim}}</a></div>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td><a href="{{url('storage/images/' . $item->bukti_pembayaran)}}">
                                                {{substr(strip_tags(htmlspecialchars_decode($item->bukti_pembayaran)),0,10)}}
                                            </a>
                                        </td>
                                        <td>
                                            ...
                                            <form action="{{route('competitions.destroy', $item->id)}}" method="POST"
                                                class="d-inline">
                                                @csrf
                                                @method('delete')

...
@section('title', 'Edit Data Peserta Lomba — Ciradyka Pramuka SMAN 1 Ciamis')
@section('content')
        ...
        <div class="page-title">
            <div class="card card-absolute">
                <div class="card-header bg-primary">
                    <h5 class="text-white">Edit Data Peserta Lomba • {{$item->nama_peserta}}</h5>
                </div>
                <div class="card-body">
                    <p>
                        Dihalaman ini anda dapat mengubah atau mengedit data milik {{$item->nama_peserta}}.
                ...
                <div class="card">
                    ...
                    <form method="POST" action="{{route('competitions.update', $item->id)}}"
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-7 mb-2">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input required id="nama_peserta" type="text" value="{{$item->nama_peserta}}"
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4 mb-2">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input id="nomor_handphone" type="tel" value="{{$item->nomor_handphone}}"
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6 mb-2">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input required id="nama_lomba" type="text" value="{{$item->nama_lomba}}"
                                            class="form-control" name="nama_lomba">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card-footer">
                            <button type="submit" class="btn btn-primary m-r-15" type="submit">Edit</button>

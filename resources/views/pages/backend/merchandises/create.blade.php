...
@section('title', 'Tambah Merchandise — Ciradyka Pramuka SMAN 1 Ciamis')
@section('content')
        ...
        <div class="page-title">
            <div class="card card-absolute">
                <div class="card-header bg-primary">
                    <h5 class="text-white">Tambah Merchandise</h5>
                </div>
                <div class="card-body">
                    <p>
                        Dihalaman ini anda dapat menambahkan barang merchandise yang nantinya akan muncul di menu
                        merchandise di halaman
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Tambah Merchandise</h5>
                    </div>
                    <div class="card-body add-post">
                        <form class="row needs-validation" method="POST" action="{{route('merchandises.store')}}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input class="form-control" id="nama_barang" name="nama_barang"
                                            value="{{old('nama_barang')}}" type="text" required="">
                                ...
                                <div class="email-wrapper">
                                    <div class="theme-form">
                                        <div class="form-group">
                                            ...
                                            <textarea id="text-box" name="deskripsi_barang" cols="10"
                                                rows="2"></textarea>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input id="harga_barang" type="text" class="form-control"
                                                value="{{ old('harga_barang') }}" name="harga_barang">
                                        </div>
                                    </div>
                                    {{-- input twitter --}}
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input id="nomor_telepon_1" type="text" class="form-control"
                                                value="{{ old('nomor_telepon_1') }}" name="nomor_telepon_1">
                                        </div>
                                    </div>
                                    {{-- input facebook --}}
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input id="nomor_telepon_2" type="text" class="form-control"
                                                value="{{ old('nomor_telepon_2') }}" name="nomor_telepon_2">
                                        </div>
                                    </div>
                                </div>
                            </div>

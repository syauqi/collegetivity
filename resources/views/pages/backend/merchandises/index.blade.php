...
@section('title', 'Data Merchandise — Ciradyka Pramuka SMAN 1 Ciamis')
@section('content')
        ...
        <div class="page-title">
            <div class="card card-absolute">
                <div class="card-header bg-primary">
                    <h5 class="text-white">Data Merchandise</h5>
                </div>
                <div class="card-body">
                    <p>Dibawah ini adalah data merchandise yang telah anda tambahkan. Data dibawah juga bisa anda
                            ...
                            <table class="display" id="auto-fill">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                                ...
                                                <div class="avatars mr-2">
                                                    <div class="avatar ratio"><img style="object-fit: cover;
                                                        ...
                                                        height: 40px;" class="b-r-8"
                                                            src="{{url('storage/images/' . $item->gambar_barang)}}">
                                                    </div>
                                                </div>
                                                <div class="flex-fill">
                                                    <div class="font-weight-bold">{{$item->nama_barang}}</div>
                                                    <div class="text-muted"><a href="#"
                                                            class="text-reset">{{$item->harga_barang}}</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td>{{substr(strip_tags(htmlspecialchars_decode($item->deskripsi_barang)),0,20)}}<a
                                                href="{{route('merchandises.show', $item->id)}}"> ...</a></td>
                                        <td>
                                            ...
                                            <a href="{{route('merchandises.edit', $item->id)}}"
                                            ...
                                            <form action="{{route('merchandises.destroy', $item->id)}}" method="POST"
                                                class="d-inline">
                                                @csrf
                                                @method('delete')

...
@section('title', 'Tambah Data Anggota — Ciradyka Pramuka SMAN 1 Ciamis')
@section('content')
        ...
        <div class="page-title">
            <div class="card card-absolute">
                <div class="card-header bg-primary">
                    <h5 class="text-white">Tambah Data Anggota</h5>
                </div>
                <div class="card-body">
                    <p>
                        Dihalaman ini anda dapat menambah data anggota. Isi data dibawah ini dengan benar dan
                ...
                <div class="card">
                    ...
                    <form method="POST" action="{{route('members.store')}}" enctype="multipart/form-data"
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-5 mb-2">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input required id="nomor_tanda_anggota" type="number" class="form-control"
                                            value="{{ old('nomor_tanda_anggota') }}" name="nomor_tanda_anggota">
                                    </div>
                                </div>
                                {{-- nama lengkap input --}}
                                <div class="form-group col-md-7 mb-2">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input required id="nama" type="text" value="{{ old('nama') }}"
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4 mb-2">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input id="handphone" type="number" value="{{ old('handphone') }}"
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4 mb-2">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input required id="angkatan" type="number" value="{{ old('angkatan') }}"
                                ...
                                <div class="form-group col-md-4 mb-2">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input required id="tahun_masuk" type="number" value="{{ old('tahun_masuk') }}"
                            ...
                            {{-- upload foto --}}
                            <label for="foto">Upload Foto (Rekomendasi 2050x780)</label>
                            <div class="input-group mb-3">

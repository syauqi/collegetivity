...
@section('title', 'Data Pengumuman — Ciradyka Pramuka SMAN 1 Ciamis')
@section('content')
        ...
        <div class="page-title">
            <div class="card card-absolute">
                <div class="card-header bg-primary">
                    <h5 class="text-white">Data Pengumuman</h5>
                </div>
                <div class="card-body">
                    <p>Dibawah ini adalah pengumuman yang telah anda tambahkan. Data dibawah juga bisa anda
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{substr(strip_tags(htmlspecialchars_decode($item->content)),0,20)}}<a
                                                href="{{route('announcements.show', $item->id)}}"> ...</a></td>
                                        <td>

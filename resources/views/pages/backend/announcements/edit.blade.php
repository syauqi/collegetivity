...
@section('title', 'Edit Pengumuman — Ciradyka Pramuka SMAN 1 Ciamis')
@section('content')
        ...
        <div class="page-title">
            <div class="card card-absolute">
                <div class="card-header bg-primary">
                    <h5 class="text-white">Edit Pengumuman • {{$item->judul}}</h5>
                </div>
                <div class="card-body">
                    <p>
                        Dihalaman ini anda dapat mengedit atau merubah pengumumuman yang telah anda tambahkan
                        sebelumnya.
                ...
                <div class="card">
                    ...
                    <div class="card-body add-post">
                        <form class="row needs-validation" method="POST"
                            action="{{route('announcements.update', $item->id)}}" enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select class="custom-select" id="inputGroupSelect01" name="kategori">
                                            <option value="{{$item->kategori}}" selected>Pilih kategori ...
                                            </option>

    ...
    <div class="container-fluid">
        <div class="hero-content">
            ...
            <span class="notice wow fadeInUp" data-wow-delay="0.5s">
                    <img src="assets/img/hero/notice-icon.png" alt="Image"> No Extra Charge &amp; We’ve a Pricing Plan
                </span>
        </div>
        ...
        <div class="row align-items-center justify-content-center p-t-130">
            <div class="col-lg-7 col-md-10 order-lg-last order-first wow fadeInUp" data-wow-delay="0.3s">
                <div class="preview-galley-v8 text-right m-b-md-80">
                    ...
                    <img src="assets/img/preview-gallery/sof-analysis-02.jpg" class="preview-two animate-float-bob-x" alt="Image">
                    <img src="assets/img/preview-gallery/sof-analysis-03.jpg" class="preview-three animate-float-bob-y" alt="Image">
                </div>
            </div>
